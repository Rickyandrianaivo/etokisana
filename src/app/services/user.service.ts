...
import { RESET_TABLES_URL, USER_BY_EMAIL_URL, USER_BY_ID_URL, USER_EMAIL_CONFIRMATION_URL, USER_LOGIN_URL, USER_NEW_URL, USER_REGISTER_URL, USER_REQUESTRESETPASSWORD_URL, USER_RESETPASSWORD_URL, USER_TOKEN_VERIFICATION_URL, USER_UPDATE_URL, USER_UPLOAD_PDP_URL, USER_URL, USER_VALIDATE_URL } from '../shared/constant/urls';
