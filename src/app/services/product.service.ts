...
import { PRODUCT_ADD_URL, PRODUCT_BY_CATEGORY_URL, PRODUCT_BY_EMAIL_URL, PRODUCT_BY_SEARCH_URL, PRODUCT_UPDATE_URL, PRODUCT_UPLOAD_IMAGE_URL, PRODUCT_URL } from '../shared/constant/urls';
